			...
			<Fragment>
				<div className={"header"}>
					<div className={`header__container container ${this.state.isMobileMenuActive ? 'active' : ''}`}>
						...
						<div className={"header__content page-header"}>
							...
							<Dropdown onShow={() => this.handleOpenDropDown()} onHide={() => this.handleCloseDropDown()} active={this.state.isOpen}>
								<DropdownTrigger>
									<div className={"token-selector__active"}>
										...
										<p style={{color:'white', fontSize: 14}}>YOLO</p>
										<img
											style={{width: '14px', marginRight: 18, marginLeft: 6}}
											className={"token-selector__active-icon"} src={require(`../../assets/images/icons/arrow-drop-down-grey.svg`)} alt="" />
									</div>
								</DropdownTrigger>
								<DropdownContent className={"common__fade-in"}>
									<div className={""}>
										<div className={"token-selector__item-container"}>
											<NavLink to="/swap/yolo1/">Yolo 1</NavLink>
											<NavLink to="/swap/yolo2/">Yolo 2</NavLink>
             							</div>
									</div>
								</DropdownContent>
							</Dropdown>
